...
import com.example.Binarfud.consumer.MessageConsumer;
import com.example.Binarfud.model.Orders;
import com.example.Binarfud.producer.MessageProducer;
...
public class OrdersService {
    ...
    public ResponseEntity<?> saveOrder(Orders order) {
        try {
            ...
            messageProducer.sendMessage("order", "Order Created: " + order.getId());
            messageProducer.sendMessage("notification", "You just created an order : " + order);
